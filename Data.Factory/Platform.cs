...
namespace Data.Factory
{
    public class Platform
    {
        ...
        public static Data.Interface.IMails GetMailsInstance()
        {
            return new Data.MSSQL.Mails();
        }

        public static Data.Interface.IMails_Detail GetMails_DetailInstance()
        {
            return new Data.MSSQL.Mails_Detail();
        }
        ...
        public static Data.Interface.IPaperDownload GetPaperDownloadInstance()
        {
            return new Data.MSSQL.PaperDownload();
        }
