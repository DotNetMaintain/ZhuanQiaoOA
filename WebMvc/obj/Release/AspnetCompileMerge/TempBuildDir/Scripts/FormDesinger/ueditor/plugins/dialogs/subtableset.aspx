...
<table cellpadding="0" cellspacing="1" border="0" width="98%" style="margin-top:6px;" class="formtable" id="maintable">
    ...
    <tr id="mode_dict" style="display:none;">
     ...
     <tr id="mode_material" style="display:none;">
        <td colspan="2">
            <table cellpadding="0" cellspacing="1" border="0" width="100%" class="formtable">
                <tr>
                    <th style="width:100px;">默认值：</th>
                    <td><select class="myselect" id="material_defaultvalue" style="width:227px"><%=defaultOptions %></select></td>
                </tr>
                <tr>
                    <th>宽度：</th>
                    <td><input type="text" id="material_width" class="mytext" style="width:150px" /></td>
                </tr>
                <tr>
                    <th>选择范围：</th>
                    <td>
                        <div>
                            <%=workFlowFrom.GetOrgRangeRadios("material_rang","") %>
                        
                        <input type="radio" name="material_rang" value="2" id="material_rang_3" style="vertical-align:middle;"/><label for="material_rang_3" style="vertical-align:middle;">自定义</label>：<input type="text" id="material_rang1" class="mymember" style="width:150px;"/></div>
                    </td>
                </tr>
                <tr>
                    <th>选择类型：</th>
                    <td><%=workFlowFrom.GetOrgSelectTypeCheckboxs("material_type","") %></td>
                </tr>
                <tr>
                    <th>多选：</th>
                    <td><input type="checkbox" value="1" id="material_more"  style="vertical-align:middle;" /><label for="material_more" style="vertical-align:middle;">是否可以多选</label></td>
                </tr>
            </table>
        </td>
    </tr>
